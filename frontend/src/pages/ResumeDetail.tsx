...
const ResumeDetail: React.FC = () => {
  ...
  const scoreColor =
    resume.match_score !== undefined
      ? resume.match_score >= 80 ? 'text-success'
      : resume.match_score >= 60 ? 'text-white'
      : resume.match_score >= 40 ? 'text-warning'
      : 'text-danger'
      : '';
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => setShowDeleteModal(true)}
              className="px-4 py-2 text-sm font-medium text-danger bg-danger/10 border border-danger/20 rounded-lg hover:bg-danger/20 transition-colors">
              Delete
            </button>
          </div>
        </div>
          ...
          <div className="bg-[#0A0A0A] border border-[#111111] rounded-lg p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className={`text-sm mt-1 ${scoreColor}`}>
                  {resume.match_score >= 80 ? 'Excellent Match' : resume.match_score >= 60 ? 'Good Match' : resume.match_score >= 40 ? 'Fair Match' : 'Poor Match'}
                </p>
              </div>
            </div>
          </div>
